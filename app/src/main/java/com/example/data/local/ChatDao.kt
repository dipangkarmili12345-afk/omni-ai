...
interface ChatDao {
    ...
    @Query("UPDATE chat_sessions SET updatedAt = :timestamp, messageCount = messageCount + 1 WHERE sessionId = :sessionId")
    suspend fun updateSessionTimestampAndCount(sessionId: String, timestamp: Long)
